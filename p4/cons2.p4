...
/*==================== CONSOLIDATION : 2 heterogeneous pipelines ====================*/
Pipeline(A_IngressParser(), A_Ingress(), A_IngressDeparser(),
         A_EgressParser(),  A_Egress(),  A_EgressDeparser()) pipeA;

Pipeline(B_IngressParser(), B_Ingress(), B_IngressDeparser(),
         B_EgressParser(),  B_Egress(),  B_EgressDeparser()) pipeB;

/* pipeA -> physical pipe 0 (arg0), pipeB -> physical pipe 1 (arg1) */
